        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center">
                <form action="{{ route('search') }}" method="GET" class="relative">
                    <input type="text" name="q" placeholder="Search..." class="w-64 rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                ...
                @auth
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('user.favorites')">
                                {{ __('My Favorites') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('user.reviews')">
                                {{ __('My Reviews') }}
                            </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 border-t border-gray-200">
            <form action="{{ route('search') }}" method="GET" class="px-4">
                <input type="text" name="q" placeholder="Search..." class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
            </form>
        </div>
        ...
        @auth
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <x-responsive-nav-link :href="route('user.reviews')">
                        {{ __('My Reviews') }}
                    </x-responsive-nav-link>
